...
| `SUPERVISOR_HTTP`                                                                                            |          | `false`             | boolean (true, false) | Enable supervisor HTTP interface for monitoring and control                                                        | ⚠️  |
| `SUPERVISOR_HTTP_PORT`                                                                                       |          | `9001`              | integer               | Port for supervisor HTTP interface                                                                                 | ⚠️  |
| `SUPERVISOR_HTTP_USER`                                                                                       |          | `admin`             | string                | Username for supervisor HTTP interface                                                                             | ⚠️  |
| `SUPERVISOR_HTTP_PASSWORD`                                                                                   |          |                     | string                | Password for supervisor HTTP interface                                                                             | ⚠️  |
